...
export interface TemplateContext {
  pluginName: string
  pluginNameCamel: string  // kebab → camelCase (z.B. my-plugin → myPlugin)
  pluginNamePascal: string // kebab → PascalCase (My Plugin → MyPlugin)
  pluginPrefix: string     // first segment for CSS/DB-prefix (my-plugin → mp)
  hosts: string[]
  features: string[]
  year: string
}
